...
- Create Angular project with ng: `ng new pedidosahorita.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`pedidosahorita.client.esproj`).
