...
INSERT INTO Usuarios (Nombre, Apellido, Email, Telefono, ContrasenaHash) VALUES (N'Bernab�', N'Peral', 'chaparroeli@macias.es', '+34730682427', '7da7bd9fae659a1437fda36a876a8b9326763728b47949bf88247a02dc538368');
...
INSERT INTO Usuarios (Nombre, Apellido, Email, Telefono, ContrasenaHash) VALUES (N'Francisco Javier', N'Alcal�', 'rosalia98@hotmail.com', '+34650 584 825', '9f45235f56d588f4cb876ef1329cc4973e0e420dfaf19c690056a283a9d0448d');
...
INSERT INTO Usuarios (Nombre, Apellido, Email, Telefono, ContrasenaHash) VALUES (N'Eva', N'Garz�n', 'abadmarco@hotmail.com', '+34848 06 11 77', '03366bd3203fd76a80e6597f7575562ceaccc019014d2b9f5605d4095583a2db');
...
INSERT INTO Usuarios (Nombre, Apellido, Email, Telefono, ContrasenaHash) VALUES (N'Mar�a Pilar', N'Galan', 'adelaida31@gmail.com', '+34700 07 14 13', '0e8fe...');
...
(10, N'Mercado R�pido', 'ES1400491500052710149034', 1);
INSERT INTO Empleados (EmpleadoID, FechaDeContratacion, FechaDeDespido, RolInterno, Salario) VALUES
(11, '2022-01-15', NULL, N'Atenci�n al Cliente', 1800.00),
(12, '2023-03-10', NULL, N'Repartidor', 1500.00),
(13, '2021-06-01', NULL, N'Soporte T�cnico', 2000.00),
...
(14, 3);
-- Categor�as
INSERT INTO CategoriasProducto (NombreCategoria) VALUES (N'Categor�a 1');
INSERT INTO CategoriasProducto (NombreCategoria) VALUES (N'Categor�a 2');
INSERT INTO CategoriasProducto (NombreCategoria) VALUES (N'Categor�a 3');
INSERT INTO CategoriasProducto (NombreCategoria) VALUES (N'Categor�a 4');
INSERT INTO CategoriasProducto (NombreCategoria) VALUES (N'Categor�a 5');
...
VALUES 
(6, 1, N'Arroz 5kg', N'Descripci�n del producto 1', 45.00, 12, N'https://img/1.jpg'),
(7, 2, N'Fideos 1kg', N'Descripci�n del producto 2', 23.00, 26, N'https://img/2.jpg'),
(10, 1, N'Aceite 1L', N'Descripci�n del producto 3', 85.00, 18, N'https://img/3.jpg'),
(6, 1, N'Azúcar 2kg', N'Descripci�n del producto 4', 21.00, 11, N'https://img/4.jpg'),
(7, 5, N'Sal 1kg', N'Descripci�n del producto 5', 87.00, 5, N'https://img/5.jpg'),
(10, 2, N'Café 250g', N'Descripci�n del producto 6', 93.00, 27, N'https://img/6.jpg'),
(10, 4, N'Galletas 500g', N'Descripci�n del producto 7', 38.00, 19, N'https://img/7.jpg'),
(10, 3, N'Huevos docena', N'Descripci�n del producto 8', 10.00, 29, N'https://img/8.jpg'),
(7, 4, N'Jugo 1L', N'Descripci�n del producto 9', 53.00, 13, N'https://img/9.jpg'),
(7, 2, N'Pan integral', N'Descripci�n del producto 10', 53.00, 8, N'https://img/10.jpg'),
(6, 4, N'Leche 1L', N'Descripci�n del producto 11', 22.00, 16, N'https://img/11.jpg'),
(8, 5, N'Cereal 300g', N'Descripci�n del producto 12', 43.00, 30, N'https://img/12.jpg'),
(8, 2, N'Mermelada 500g', N'Descripci�n del producto 13', 54.00, 22, N'https://img/13.jpg'),
(9, 2, N'Mantequilla 200g', N'Descripci�n del producto 14', 95.00, 20, N'https://img/14.jpg'),
(7, 5, N'Yogurt 1L', N'Descripci�n del producto 15', 94.00, 13, N'https://img/15.jpg');
